...
def send_price_alert_email(price_alert, check_price_below_threshold):
    ...
    notify_user_from_db(price_alert, check_price_below_threshold)
...
def cron_job_run():
    ...
    send_price_alert_email(price_alert, check_price_below_threshold)            # Send email is latest price is below threshold price
